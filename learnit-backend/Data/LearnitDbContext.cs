...
public partial class LearnitDbContext : DbContext
{
    ...
    protected override void OnConfiguring(DbContextOptionsBuilder optionsBuilder)
        => optionsBuilder.UseSqlServer("Server=.\\SQLExpress;Database=learnitDb;Trusted_Connection=True;TrustServerCertificate=True;");
        ...
        modelBuilder.Entity<Assignment>(entity =>
{
    ...
    entity.HasKey(e => e.AQuestionId).HasName("PK__assignment__621F9B45755C35B7"); // Set the primary key

    entity.Property(e => e.AQuestionId).HasColumnName("a_question_id"); // Map the column names
    ...
    entity.HasOne(d => d.Course)
        ...
        {
            entity.HasKey(e => e.CommentId).HasName("PK_comments_1");
